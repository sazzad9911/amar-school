    ...
    <ScrollView style={{ padding: 20 }}>
      ...
      <Button
        onPress={() => {
          ...
          addToCart(userInfo, undefined, course.bundle.id)
            .then((res) => {
      ...
      <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
        <EvilIcons
          onPress={() => {
            console.log(course);
            addWishList(userInfo.meta.token, undefined, course.bundle.id)
              .then((res) => {
      ...
      <Text style={{ fontWeight: "500", fontSize: 18 }}>Course Details</Text>
